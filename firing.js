...
(function () {
  ...
  window.issueFiring = function () {
    ...
    const finalBanLine = finalBanChk.checked ? `\ررابعًا: منع نهائي من الهلال الاحمر` : '';
...
\`\`\`
\`\`\`cs
# بعد الاطلاع على نظام التوظيف والترقيات وانهاء الخدمة الصادر من قيادة الهلال الاحمر قررنا مايلي 
 
أولًا: تنهى خدمات المسعف ادناه اعتبارا من تاريخه
ثانيًا: منع توظيف ${ban} يوم
ثالثًا: غرامه مالية قدرها ${fine} تسلم الى خزينة الهلال الاحمر${finalBanLine}
